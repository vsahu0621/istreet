  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          _headerCard("Welcome back Advisor!"),
          const SizedBox(height: 20),
          _sectionTitle("Client Tools"),
          _optionCard(Icons.people, "My Clients", "Manage and track clients"),
          _optionCard(Icons.trending_up, "Investment Plans", "Create advisory plans"),
          _optionCard(Icons.notifications, "Client Notifications", "Send updates"),
        ],
      ),
    );
  }
