  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          _headerCard("Welcome back Investor!"),
          const SizedBox(height: 20),
          _sectionTitle("Portfolio"),
          _optionCard(Icons.account_balance_wallet, "My Portfolio", "View your holdings"),
          _optionCard(Icons.show_chart, "Market Trends", "Latest market insights"),
          _optionCard(Icons.star, "Recommendations", "Top picks for you"),
        ],
      ),
    );
  }
